                            ...
                            <div class="tm:w-1/2 px-4 py-6 bg-gray-100 dark:bg-gray-800">
                                <form action="{{ route('tracks.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input type="file" name="img" id="image" aria-describedby="file_input_help" accept="image/*" onchange="displayImagePreview(event)" class="block w-full text-sm file-btn text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="input dark:text-black" required pattern="^[\s\p{L}\d]+$" minlength="2" maxlength="50">
                                    </div>
                                    <div class="mt-4">
                                        <label for="description" class="block font-semibold text-gray-900 dark:text-white">Description:</label>
                                        <textarea id="description" name="description" class="input dark:text-black" value="{{ old('description') }}" required pattern="^[\s\p{L}\d]+$" minlength="2"></textarea>
                                    </div>
                                    <div class="mt-4">
                                        <label for="price_per_hour" class="block font-semibold text-gray-900 dark:text-white">Price per Hour:</label>
                                        <input type="number" id="price_per_hour" name="price_per_hour" value="{{ old('price_per_hour') }}" class="input dark:text-black" required min="1">
                                    </div>
                                    <div class="mt-4">
