              ...
              <form action="{{ route('reservations.update', ['id' => $reservation->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-4">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" name="price" id="price" class="w-full p-2 border-gray-300 rounded focus:outline-none focus:border-blue-500 text-gray-800" value="{{ old('price', $reservation->price) }}" required>
                    @error('price')
                      <p class="text-red-500">{{ $message }}</p>
                    @enderror
                  </div>
