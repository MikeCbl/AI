                      ...
                      <form action="{{ route('users.update', ['id' => $user->id]) }}" method="POST" class="mt-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <input type="text" name="name" id="name" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="name" value="{{ $user->name }}"  required>
                          </div>
                                @if ($errors->has('name'))
                          ...
                          <div>
                            ...
                            <input type="text" name="last_name" id="last_name" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="last name" value="{{ $user->last_name }}" required>
                          </div>
                          <div>
                            <label for="birth_place" class="block font-medium">Birth Place</label>
                            <input type="text" name="birth_place" id="birth_place" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="name" value="{{ $user->birth_place }}"  required>
                          </div>
                          <div>
                            <label for="birth_date" class="block font-medium">Birthday</label>
                            <input type="date" name="birth_date" id="birth_date" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950"  value="{{ $user->birth_date }}" required>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <input type="number" name="phone" id="phone" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="e.g. 74 3456 789" value="{{ $user->phone }}" required>
                          </div>

                          <div>
                            <label for="pesel" class="block font-medium">Pesel</label>
                            <input type="text" name="pesel" id="pesel" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="pesel" value="{{ $user->pesel }}" required>
                          </div>
                          <div>
                            <label for="residential_address" class="block font-medium">Residential Address</label>
                            <input type="text" name="residential_address" id="residential_address" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="pesel" value="{{ $user->residential_address }}" required>
                          </div>
                          {{-- <div>
                            <label for="gender" class="block font-medium">Gender</label>
                            <input type="text" name="gender" id="gender" class="w-full px-4 py-2 mt-1 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-slate-950" placeholder="pesel" value="{{ $user->gender }}" required>
                          </div> --}}
                          <div class="mx-2 mt-4">
